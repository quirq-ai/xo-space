...
ollama, local, openai-subscription). Responses here shape what the UI sees
in provider menus and the settings screen. The per-agent model listing is
`api/models/routes.py`.
