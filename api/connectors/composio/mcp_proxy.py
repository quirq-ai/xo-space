...
# The proxy URLs are what agents' MCP configs point at, fixed outside /api.
...
@absolute_router.post("/mcp/composio-proxy/")
@absolute_router.post("/mcp/composio-proxy")
@absolute_router.post("/mcp/cowork-proxy/")
@absolute_router.post("/mcp/cowork-proxy")
async def mcp_proxy_post(request: Request):
    return await _proxy(request, "POST")


@absolute_router.get("/mcp/composio-proxy/")
@absolute_router.get("/mcp/composio-proxy")
@absolute_router.get("/mcp/cowork-proxy/")
@absolute_router.get("/mcp/cowork-proxy")
async def mcp_proxy_get(request: Request):
    return await _proxy(request, "GET")


@absolute_router.delete("/mcp/composio-proxy/")
@absolute_router.delete("/mcp/composio-proxy")
@absolute_router.delete("/mcp/cowork-proxy/")
@absolute_router.delete("/mcp/cowork-proxy")
async def mcp_proxy_delete(request: Request):
    return await _proxy(request, "DELETE")


@absolute_router.post("/mcp/composio-proxy/u/{token}/")
@absolute_router.post("/mcp/composio-proxy/u/{token}")
@absolute_router.post("/mcp/cowork-proxy/u/{token}/")
@absolute_router.post("/mcp/cowork-proxy/u/{token}")
async def mcp_proxy_post_scoped(request: Request, token: str):
    return await _proxy(request, "POST", token)


@absolute_router.get("/mcp/composio-proxy/u/{token}/")
@absolute_router.get("/mcp/composio-proxy/u/{token}")
@absolute_router.get("/mcp/cowork-proxy/u/{token}/")
@absolute_router.get("/mcp/cowork-proxy/u/{token}")
async def mcp_proxy_get_scoped(request: Request, token: str):
    return await _proxy(request, "GET", token)


@absolute_router.delete("/mcp/composio-proxy/u/{token}/")
@absolute_router.delete("/mcp/composio-proxy/u/{token}")
@absolute_router.delete("/mcp/cowork-proxy/u/{token}/")
@absolute_router.delete("/mcp/cowork-proxy/u/{token}")
