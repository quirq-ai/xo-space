...
@router.post("/{toolkit}/disconnect")
...
@router.post("/{toolkit}/accounts/{connected_account_id}/unlink")
...
@router.put("/{toolkit}/accounts/{connected_account_id}/alias")
