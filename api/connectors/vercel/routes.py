...
router = APIRouter()
# Fixed by the OAuth redirect and RFC 9728, so not under /api/connectors/vercel.
...
@absolute_router.get("/.well-known/oauth-protected-resource")
...
@absolute_router.options("/.well-known/oauth-protected-resource")
