...
from api.xo_projects._visualizer_models import (
    ActivityResponse,
    AdoptIssueRequest,
    AnalyticsStats,
...
from api.xo_projects._visualizer_presenter import (
...
@router.get(
    "/{project_id}/workitems/{workitem_id}",
    response_model=Workitem,
)
...
@router.post(
    "/{project_id}/workitems/{workitem_id}/claim",
...
@router.post(
    "/{project_id}/github/issues/{issue_number}/adopt",
    response_model=Workitem,
    status_code=201,
)
...
@router.delete(
    "/{project_id}/workitems/{workitem_id}/adoption",
    response_model=Workitem,
)
...
@router.put(
    "/{project_id}/workitems/{workitem_id}/assignee",
...
@router.get(
    "/{project_id}/usage/sessions/{session_id}",
    response_model=SessionCostSummary,
)
