...
from api.xo_projects.visualizer import (
    _SELF_ALIASES,
    _DOCUMENT_ERRORS,
...
def workspace_timeline(
    ...
    Reads ``~/.quirq/projects/timeline.jsonl``: history in the state root,
    beside the per-project timelines. Empty if the watcher has not materialised it yet.
    """
...
# Registered by api/workspace/routes.py: the URL is /api/workspace/workitems.
