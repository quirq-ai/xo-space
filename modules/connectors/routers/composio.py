...
from modules.connectors.composio import client as composio_client
from modules.connectors.composio import service as composio_service
from modules.connectors.composio import space_scope
from modules.connectors.composio.identity import get_composio_user

from .. import service as connectors
...
async def get_backend(request: Request) -> JSONResponse:
    ...
    return JSONResponse(connectors.composio_status())
