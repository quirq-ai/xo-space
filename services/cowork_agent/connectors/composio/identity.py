...
(``routers.auth.auth.get_auth_token`` takes no arguments) and runs in exactly one Coder
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail=(
                ...
                f"{state.WORKSPACE_ENV} is injected by the Coder pod."
            ),
        )
