...
Named for the watcher's sinks, which were once the only caller; the
request threads behind the todos and workitems APIs use the same
primitives now, and :func:`append_jsonl` in particular has four writers
