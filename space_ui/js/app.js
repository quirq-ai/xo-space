...
import projectsView from './views/projects.js?v=20260907-sharing7';
...
import wikiView from './views/wiki.js?v=20260904-tenancy1';
import quirqView from './views/quirq.js?v=20260817-plural1';
import secretsView from './views/secrets.js?v=20260828-reporting1';
import connectorsView from './views/connectors.js?v=20260904-tenancy1';
