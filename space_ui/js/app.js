...
import {initServerWidget} from './core/server-widget.js?v=20260913-commands1';
...
import wikiView from './views/wiki.js?v=20260913-commands1';
import quirqView from './views/quirq.js?v=20260817-plural1';
import secretsView from './views/secrets.js?v=20260913-commands1';
