...
import projectsView from './views/projects.js?v=20260914-projectmanage1';
import treeView from './views/tree.js?v=20260914-projectmanage1';
import sharingView from './views/sharing.js?v=20260914-projectmanage1';
...
import setupView,{createConnectorsView,secretsView} from './views/secrets.js?v=20260914-projectmanage1';
