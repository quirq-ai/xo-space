...
import {registerView,startRegistry,switchTo} from './core/registry.js?v=20260914-navigation1';
...
import {initSectionNav} from './core/section-nav.js?v=20260914-controls1';
import {PRIMARY_TABS} from './core/navigation.js?v=20260914-files2';
import {initPreview} from './core/preview.js?v=20260914-files2';
import {dashboardView,graphView,timeView,initProjectRootPicker} from './views/atlas.js?v=20260914-controls1';
...
import projectsView from './views/projects.js?v=20260914-controls1';
import treeView from './views/tree.js?v=20260914-controls1';
import sharingView from './views/sharing.js?v=20260914-controls1';
...
import {createSetupViews} from './views/setup.js?v=20260914-files2';
