...
import {initCommandPalette} from './core/command-palette.js?v=20260916-jobs1';
...
import {createInboxViews,initInboxBadge} from './views/inbox.js?v=20260916-jobs1';
...
import wikiView from './views/wiki.js?v=20260916-jobs1';
import quirqView from './views/quirq.js?v=20260915-data1';
import {createSetupViews} from './views/setup.js?v=20260916-jobs1';
