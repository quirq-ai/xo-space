...
const NAV=[
  ...
  ['work','Inbox','Work','inbox feed needs you attention work items assigned'],
  ['work/live','Live','Work','live stream log calendar schedule jobs running now sessions pollers'],
  ['work/history','History','Work','history activity charts range space projects sharing repos agents issues connections'],
