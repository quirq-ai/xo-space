    ...
    <div class="setup-layout">
      ...
      <div class="setup-content">
        ...
        <section class="setup-panel" id="setup-panel-server" aria-labelledby="setup-server-title" hidden>
          <header class="setup-section-head"><h2 id="setup-server-title" tabindex="-1">Server</h2><p>Connect MCP apps and the command line, apply saved changes, and keep Space up to date.</p></header>
          <section class="setup-card setup-mcp" id="setup-mcp" aria-labelledby="setup-mcp-title"></section>
          <section class="setup-card setup-cli" id="setup-cli" aria-labelledby="setup-cli-title"></section>
