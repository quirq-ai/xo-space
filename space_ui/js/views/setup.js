...
import {mountTheme} from './setup-theme.js?v=20260922-theme1';
import {mountSetupSearch} from './setup-search.js?v=20260922-theme1';
import {renderSetupShell} from './setup-shell.js?v=20260922-theme1';
...
function bindEvents(){
  ...
  root.querySelector('#setup-refresh').addEventListener('click',()=>{loadAll();identity?.refresh();branding?.refresh();theme?.refresh();});
