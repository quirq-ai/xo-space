...
try{
  ...
  await page.locator('.prj-drawer:not([hidden]) [data-panel="files"] [data-file="README.md"]').waitFor();
  const drawer=await page.locator('#prj-drawer-aurora-console').elementHandle();
  await page.locator('.prj-drawer:not([hidden]) [data-panel="files"] [data-file="README.md"]').click();
