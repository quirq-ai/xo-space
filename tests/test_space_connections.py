...
class CacheBusterTests(unittest.TestCase):
    ...
    def test_app_js_imports(self) -> None:
        ...
        self.assertIn("import connectorsView from './views/connectors.js?v=20260918-dynamic4';", app)
    ...
    def test_index_html_links(self) -> None:
        ...
        self.assertIn('<link rel="stylesheet" href="css/connectors.css?v=20260918-dynamic4">', html)
