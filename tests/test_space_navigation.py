...
assert.deepEqual(PROJECT_PAGES.map(page=>[page.id,page.route,page.label]),[
  ['dashboard','projects/overview','Overview'],['project-list','projects/list','List'],
  ['graph','projects/graph','Graph'],['tree','projects/tree','Tree'],
...
await registry.switchTo('projects/list');
