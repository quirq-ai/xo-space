...
const refreshBtn={...listened,listeners:{}};
const refresh=()=>fire(refreshBtn,'click',{});
const root={
  innerHTML:'',
  querySelector(sel){
...
class ShellTests(unittest.TestCase):
    ...
    def test_stamps_moved_together(self) -> None:
        ...
        self.assertIn("./views/connectors.js?v=20260921-cardpopup1'", app)
        ...
        # connector tiles that open their card in a popup restamped connectors.css
